...
- We have used the code of original UnityExplorerPlus. It uses the MIT license, and the license can be found [here](https://github.com/MCXGK3/UEP/blob/For_CUE/Licenses/LICENSE(UnityExplorerPlus))
