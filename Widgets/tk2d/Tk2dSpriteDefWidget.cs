...
namespace UnityExplorerPlus.Widgets.tk2d
{
	...
	internal class Tk2dSpriteDefWidget : Texture2DWidget
	{
		...
		public override GameObject CreateContent(GameObject uiRoot)
		{
			...
			GameObject idRow = UIFactory.CreateHorizontalGroup(this.textureViewerRoot.transform.GetChild(0).gameObject, "SpriteIDRow", true, true, true, true, 2, new Vector4(2f, 2f, 2f, 2f), default(Color), null);
			...
			Text spriteIdLabel = UIFactory.CreateLabel(idRow, "SpriteIDLabel", "SpriteId:", (TextAnchor)3, default(Color), true, 14);
